...
const catalog = {
  ...
  CAJA_ABRIR: ["CAJA", "ABRIR", "Abrir turno", "Iniciar turno operativo de caja.", RISK.OPERACION],
  ...
  CASH_OPEN: ["CAJA", "OPEN", "Abrir turno", "Abrir turno operativo de caja.", RISK.OPERACION],
  CASH_CLOSE_OWN: ["CAJA", "CLOSE_OWN", "Cerrar caja propia", "Cerrar la sesion de caja propia.", RISK.OPERACION],
  CASH_CLOSE_OTHERS: ["CAJA", "CLOSE_OTHERS", "Cerrar caja de otros", "Cerrar o conciliar una sesion de otro usuario.", RISK.CRITICO],
  CASH_MOVEMENT_ENTRY: ["CAJA", "ENTRY", "Entrada manual", "Registrar entradas manuales de efectivo.", RISK.CRITICO],
  CASH_MOVEMENT_WITHDRAWAL: ["CAJA", "WITHDRAWAL", "Retiro manual", "Registrar retiros manuales de efectivo.", RISK.CRITICO],
  CASH_VIEW_SUMMARY: ["CAJA", "SUMMARY", "Ver resumen de caja", "Consultar resumen operativo de caja.", RISK.CONSULTA],
  CASH_VIEW_HISTORY: ["CAJA", "HISTORY", "Ver historial de caja", "Consultar historial de sesiones y movimientos de caja.", RISK.CONSULTA],
  CASH_VIEW_SALES_SUMMARY: ["CAJA", "SALES_SUMMARY", "Ver ventas de turno", "Consultar totales comerciales del turno.", RISK.CONSULTA],
  CASH_VIEW_MOVEMENTS: ["CAJA", "MOVEMENTS", "Ver movimientos", "Consultar movimientos de efectivo.", RISK.CONSULTA],
  CASH_VIEW_EXPECTED_BALANCE: ["CAJA", "EXPECTED", "Ver esperado", "Consultar efectivo esperado de caja.", RISK.CRITICO],
  CASH_REVEAL_EXPECTED_BALANCE: ["CAJA", "REVEAL", "Revelar esperado", "Mostrar efectivo esperado antes del conteo.", RISK.CRITICO],
  CASH_REVIEW_INCIDENTS: ["CAJA", "INCIDENTS", "Revisar incidencias", "Consultar incidencias y diferencias de caja.", RISK.CRITICO],
  CASH_RESOLVE_DISCREPANCY: ["CAJA", "RESOLVE", "Resolver diferencias", "Resolver diferencias e incidencias de caja.", RISK.DESTRUCTIVO],
  CASH_MANAGE_POLICY: ["CAJA", "POLICY", "Gestionar politica", "Modificar reglas de cierre, conteo y relevo.", RISK.CRITICO],
