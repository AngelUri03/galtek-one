...
export default function Promociones() {
  ...
  const editarPromo = (id) => alert(`Editar promoción con id ${id}`);
  const eliminarPromo = (id) => setPromociones((prev) => prev.filter((p) => p.id !== id));
    ...
    <div className="contenedor-principal">
      ...
      <div className="formulario">
        ...
        <div className="campo">
          ...
          <InputText value={codigo} onChange={(e) => setCodigo(e.target.value)} className="input-full" />
        </div>

        <div className="campo">
          <label>Nombre de la Promoción</label>
          <InputText value={nombrePromo} onChange={(e) => setNombrePromo(e.target.value)} className="input-full" />
        </div>
        ...
        <div className="boton-derecha">
          <Button label="Crear Promoción" onClick={crearPromocion} className="boton-verde" />
        </div>
      </div>
              ...
              <div className="promo-info">
                ...
                <div className="promo-buttons">
                  <Button
                    ...
                    size="small"
                  />
                  <Button label="Editar" icon="pi pi-pencil" onClick={() => editarPromo(promo.id)} className="p-button-info" size="small" />
                  <Button label="Eliminar" icon="pi pi-trash" onClick={() => eliminarPromo(promo.id)} className="p-button-danger" size="small" />
                </div>
              </div>
            </div>
          ))
