...
public class HistorialCostosController {
    ...
    public ResponseEntity<Object> postHistorialCostos(@RequestHeader(name = "user", required = true) String user,
        ...
        long startTime = System.currentTimeMillis();
        try {
            // Nota: Cambié service.create() por service.registrarCambioCosto() 
            // para que coincida con el método real que tienes en tu ServiceImpl
            Object resp = historialCostosService.registrarCambioCosto(entity);
